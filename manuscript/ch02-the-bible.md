...
In this chapter, you'll learn about the best-selling book of all time, the one that has been misinterpreted and abused countless times in recent memory. You should understand what the Bible _is_ and _isn't_, so that you see God's message clearly, without the fog of willful ignorance.
- The Bible is not a rulebook.
- It's not an instruction manual.
- It's not a single document written by one author with one message.
- And it is absolutely not a weapon to be aimed at people you disagree with.
...
[2]: https://www.esv.org/Leviticus+11/
[3]: https://www.esv.org/Mark+7/
[4]: https://www.esv.org/Philippians+4/
